...
if __name__ == "__main__":
    ...
    eval(test_loader, criterion_eval, load_model(lstm=True))
    eval(test_loader, criterion_eval, load_model(dropout=True))
    eval(test_loader, criterion_eval, load_model(adamw=True))